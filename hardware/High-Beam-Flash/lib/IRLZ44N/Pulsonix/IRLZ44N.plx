...
(library Library_1
	...
	(patternDef "TO254P469X1042X1967-3P" (originalName "TO254P469X1042X1967-3P")
		...
		(layerContents (layerNumRef 28)
			(line (pt -2.73 3.15) (pt 7.81 3.15) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.81 3.15) (pt 7.81 -1.54) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.81 -1.54) (pt -2.73 -1.54) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.73 -1.54) (pt -2.73 3.15) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.73 1.88) (pt -1.46 3.15) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "IRLZ44N" (originalName "IRLZ44N") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		...
		(attr "<Hyperlink>" "https://www.mouser.com/catalog/specsheets/international rectifier_irlz44n.pdf")
		(attr "<Component Height>" "4.69")
		(attr "<STEP Filename>" "IRLZ44N.stp")
